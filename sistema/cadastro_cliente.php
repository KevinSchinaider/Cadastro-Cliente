...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="offcanvas-body">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/Tela_Cadastro/cadastro_fornecedor.php">Cadastro de Fornecedor</a>
            </li>
            <li class="nav-item">
...
<form action="/Tela_Cadastro/insert_usuario.php" method="post">
<div class="container">  
    <div class="row" style="margin-top: 100px";> 
        <h2>Cadastro</h2>
        <div class="row">
            <div class="col-12">
              <input type="text" class="form-control" placeholder="Nome do Cliente" aria-label="First name" name="nome">
            </div>
    ...
    <div class="col-3 espacamento">
        ...
        <div class="col-6 espacamento">
            <input type="text" class="form-control" id="rg" placeholder="RG" aria-label="Last name" name="rg">
        </div>
